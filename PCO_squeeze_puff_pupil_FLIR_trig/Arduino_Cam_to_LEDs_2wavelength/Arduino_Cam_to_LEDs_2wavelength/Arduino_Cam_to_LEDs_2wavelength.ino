...
int LED1 = 9;  //LED1 output pin, for our setup, it is green light
int LED2 = 10;  //LED2 output pin, for the setup, it is blue light
...
void loop()
{
  ...
  if (trialstate == HIGH) // the trial is running
  {
    inp_source = 2; // LabVIEW code is running
    if (lasttrialstate == 0)
    {
  ...
  {
    inp_source = 3; // waveform generator is running
    lasttrialstate = 0;
  }
